                        ...
                        <tbody>
                            @foreach ($allotments as $allotment)
                                <tr>
                                    ...
                                    <td>{{ $allotment->notification->id }}/{{ $allotment->rand }}/{{ $allotment->sl }}
                                    </td>
                                    <td>
                                        <a
                                            href="/application/{{ $allotment->application->id }}?mzuid={{ $allotment->application->mzuid }}">{{ $allotment->application->id }}</a>
                                    </td>
                                    <td>
                                    ...
                                    <td><a
                                            href="/notification/{{ $allotment->notification->id }}">{{ $allotment->notification->no }}</a>
                                    </td>
                                    <td>
                                        @if ($allotment->admission(App\Models\Sessn::current()->id))
                                ...
                                <footer>
                                    ...
                                    <tr>
                                        <td colspan="6">
                                            ...
                                            <button id="undo-notify" class="btn btn-primary btn-action" type="button"
                                                value="notify">Undo selected notifies</button>
