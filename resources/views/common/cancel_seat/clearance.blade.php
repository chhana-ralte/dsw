        ...
        <form id="certificateForm" class="form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="departmentInput" name="department"
                    value="{{ $cancel_seat->allotment->person->student()->department }}">
            </div>
            <div class="form-group">
                <label for="course">Course</label>
                <input type="text" id="courseInput" name="course"
                    value="{{ $cancel_seat->allotment->person->student()->course }}">
            </div>
            <div class="form-group">
                <label for="room">Room</label>
                <input type="text" id="roomInput" name="room"
                    value="{{ $cancel_seat->allot_seat->seat->room->roomno }}">
            </div>
            <div class="form-group">
                <label for="duration">Duration</label>
                <input type="text" id="durationInput" name="duration"
                    value="{{ $cancel_seat->allotment->from_dt }} to {{ $cancel_seat->leave_dt }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="statusInput" name="status"
                    value="{{ $cancel_seat->clear ? 'Cleared' : 'Not Cleared' }}">
            </div>
            <div class="form-group">
                <label for="warden">Warden Name</label>
                <input type="text" id="wardenInput" name="warden"
                    value="{{ $cancel_seat->allot_hostel->hostel->warden()->name }}">
            </div>
        </form>
    </div>
    ...
    <div class="certificate">
        ...
        <div class="content">
            <p>
                ...
                of <span id="department">Biotechnology</span>, Mizoram University, has successfully cleared all his dues
                with the
        ...
        <div class="particulars">
            ...
            <div class="details">
                ...
                <p><span class="label">Duration of Stay/ Allotment:</span> From: <span id="duration">Nov. 2024-May
                        2025</span></p>
