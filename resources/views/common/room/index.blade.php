        ...
        <x-block>
            <x-slot name="heading">
                    ...
                    <div class="col-auto">
                        <div class="dropdown">
                            ...
                            >
                                <li><a
                                        class="dropdown-item"
                                        href="/hostel/{{ $hostel->id }}/room"
                                    >All rooms</a></li>
                                <li><a
                                        class="dropdown-item"
                                        href="/hostel/{{ $hostel->id }}/room?status=vacant"
                                    >Vacant
                                        rooms/seats</a></li>
                                <li><a
                                        class="dropdown-item"
                                        href="/hostel/{{ $hostel->id }}/room?status=non-available"
                                    >Non-available
                                        rooms/seats</a></li>
                            </ul>
                        </div>
                ...
                <div class="justify-between row">
                    ...
                    @auth
                    @if(auth()->user()->can('manage',$hostel))
                    <div class="col-auto">
                        <a
                            class="btn btn-primary btn-sm"
                            href="/hostel/{{ $hostel->id }}/room/create"
                        >Create new
                            room</a>
                    </div>
                    @endif
            ...
            <div style="width: 100%; overflow-x: auto; ;">
                <table
                    class="table table-auto table-hover"
