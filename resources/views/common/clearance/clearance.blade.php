...
<body>
    ...
    <div class="letter-info">
        ...
        <p>Aizawl, <span id="date">{{ date_format(date_create($clearance->issue_dt), 'jS M Y') }}</span>
        </p>
    </div>
    ...
    <div class="content">
        <p>
            ...
            {{ $clearance->rollno }} Mizoram University, has successfully cleared all his/her dues
            with the
            {{ ucfirst($clearance->hostel) }} Hall of Residence in line with the production of admission payment receipt
            and clearance from Prefect/Mess secretary of the Hostel.
        </p>
    </div>
    ...
    <div class="particulars">
        ...
        <div class="details">
            ...
            <p><span class="label">Department:</span> <span id="departmentDetail">{{ $clearance->department }}</span>
            </p>
            <p><span class="label">Hostel Room:</span> <span id="room">{{ $clearance->roomno }}</span></p>
            <p><span class="label">Expected date of Departure:</span> <span
                    id="departure">{{ $clearance->leave_dt }}</span>
            </p>
    ...
    <div class="verification">
        <p>
            After due verification, it is confirmed that <span id="nameVerification">{{ $clearance->name }}</span> has
            no outstanding dues with the hostel, subject to
            the clearance of the ongoing mess fee dues.
        </p>
        <p>
