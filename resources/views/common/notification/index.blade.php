    ...
    <x-container>
        <x-block>
            ...
            <div style="width: 100%; overflow-x:auto">
                    ...
                    <tbody>
                        ...
                        @foreach($notifications as $notif)
                            <tr class="table-white">
                                <td><input type="checkbox" name="notification_ids[]"></td>
                                <td>{{ $sl++ }}</td>
                ...
                <div>
                    <button type="button" class="btn btn-primary" name="btn-modal-show">Add to Notification Master</button>
                </div>
            </div>
        </x-block>
    </x-container>
{{-- Modal for add to file master --}}
    <div class="modal fade" id="notifMasterModal" tabindex="-1" aria-labelledby="notifMasterModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form>
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="noti_master_id">
...
$(document).ready(function(){
    ...
    $("button.btn-save").click(function(){
        ...
        $.ajax({
            url : '/ajax/addToNotiMaster',
            type : 'post',
            data : {
                'notification_ids' : $("input[name='notification_ids[]']"),
                'noti_master_id' : $("select[name='notiMaster_id']").val()
            },
