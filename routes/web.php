...
Route::get('/application/notify-all', [ApplicationController::class, 'notify_all'])->middleware(['auth', 'admin']);
Route::post('/application/notify-all', [ApplicationController::class, 'notify_all_store'])->middleware(['auth', 'admin']);
